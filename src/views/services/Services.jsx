...
const PhotoRestorationafterImage =
...
const data = [
  ...
  {
    // id: 0,
    beforeImage: cloppingpathbeforeImage,
    afterImage: cloppingpathafterImage,
    to: "/services/cloppingpath",
    title: "Clipping Path",
    description:
  ...
  {
    // id: 0,
    beforeImage: SymmetricShapingWrinklesRemovebeforeImage,
    afterImage: SymmetricShapingWrinklesRemoveafterImage,
    to: "/services/SymmetricShapingWrinklesRemove",
    title: "Symmetric Shaping & Wrinkles Remove",
    description:
      "Lizards are a widespread group of squamate reptiles, with over 6,000 species, ranging across all continents except Antarctica",
  },
  {
    // id: 0,
    beforeImage: HighEndModelRetouchingbeforeImage,
    afterImage: HighEndModelRetouchingafterImage,
    to: "/services/HighEndModelRetouching",
    title: "High-End Model Retouching",
    description:
      "Lizards are a widespread group of squamate reptiles, with over 6,000 species, ranging across all continents except Antarctica",
  },
  {
    // id: 0,
    beforeImage: ProductPhotoRetouchingbeforeImage,
    afterImage: ProductPhotoRetouchingafterImage,
    to: "/services/ProductPhotoRetouching",
  ...
  {
    // id: 0,
    beforeImage: JewelryRetouchingbeforeImage,
    afterImage: JewelryRetouchingafterImage,
    to: "/services/JewelryRetouching",
  ...
  {
    // id: 0,
    beforeImage: ModelPhotoLiquifyRetouchingbeforeImage,
    afterImage: ModelPhotoLiquifyRetouchingafterImage,
    to: "/services/ModelPhotoLiquifyRetouching",
    title: "Model Photo Liquify & Retouching",
    description:
      "Lizards are a widespread group of squamate reptiles, with over 6,000 species, ranging across all continents except Antarctica",
  },
  {
    // id: 0,
    beforeImage: ImageMaskingbeforeImage,
    afterImage: ImageMaskingafterImage,
    to: "/services/ImageMasking",
    title: "Image Masking",
    description:
      "Lizards are a widespread group of squamate reptiles, with over 6,000 species, ranging across all continents except Antarctica",
  },
  {
    // id: 0,
    beforeImage: NaturalShadowbeforeImage,
    afterImage: NaturalShadowafterImage,
    to: "/services/NaturalShadow",
  ...
  {
    // id: 0,
    beforeImage: ColorCorrectionbeforeImage,
    afterImage: ColorCorrectionafterImage,
    to: "/services/ColorCorrection",
  ...
  {
    // id: 0,
    beforeImage: ColorChangingbeforeImage,
    afterImage: ColorChangingafterImage,
    to: "/services/ColorChanging",
  ...
  {
    // id: 0,
    beforeImage: ReflectionCreationbeforeImage,
    afterImage: ReflectionCreationafterImage,
    to: "/services/ReflectionCreation",
  ...
  {
    // id: 0,
    beforeImage: NeckJointGhostMannequinbeforeImage,
    afterImage: NeckJointGhostMannequinafterImage,
    to: "/services/NeckJointGhostMannequin",
    title: "Neck Joint Ghost Mannequin",
    description:
      "Lizards are a widespread group of squamate reptiles, with over 6,000 species, ranging across all continents except Antarctica",
  },
  {
    // id: 0,
    beforeImage: ImageManipulationbeforeImage,
    afterImage: ImageManipulationafterImage,
    to: "/services/ImageManipulation",
  ...
  {
    // id: 0,
    beforeImage: MultipleClippingPathbeforeImage,
    afterImage: MultipleClippingPathafterImage,
    to: "/services/MultipleClippingPath",
    title: "Multiple ClippingPath",
    description:
      "Lizards are a widespread group of squamate reptiles, with over 6,000 species, ranging across all continents except Antarctica",
  },
  {
    // id: 0,
    beforeImage: PattanChingebeforeImage,
    afterImage: PattanChingeafterImage,
    to: "/services/PattanChinge",
    title: "Pattan Chinge",
    description:
      "Lizards are a widespread group of squamate reptiles, with over 6,000 species, ranging across all continents except Antarctica",
  },
  {
    // id: 0,
    beforeImage: ServRastertoVectorConversionicesbeforeImage,
    afterImage: ServRastertoVectorConversionicesafterImage,
    to: "/services/ServRastertoVectorConversionices",
    title: "ServRaster to Vector Conversionices",
    description:
      "Lizards are a widespread group of squamate reptiles, with over 6,000 species, ranging across all continents except Antarctica",
  },
  {
    // id: 0,
    beforeImage: RealEstatePhotoEditingRetouchingServicesbeforeImage,
    afterImage: RealEstatePhotoEditingRetouchingServicesafterImage,
    to: "/services/RealEstatePhotoEditingRetouchingServices",
    title: "Real Estate Photo Editing & Retouching Services",
    description:
      "Lizards are a widespread group of squamate reptiles, with over 6,000 species, ranging across all continents except Antarctica",
  },
  {
    // id: 0,
    beforeImage: D360PackshotRetouchingbeforeImage,
    afterImage: D360PackshotRetouchingafterImage,
    to: "/services/3D360PackshotRetouching",
    title: "3D 360° Packshot Retouching",
    description:
      "Lizards are a widespread group of squamate reptiles, with over 6,000 species, ranging across all continents except Antarctica",
  },
  {
    // id: 0,
    beforeImage: PhotoRestorationbeforeImage,
    afterImage: PhotoRestorationafterImage,
    to: "/services/PhotoRestoration",
...
export default function Services() {
  return (
    <div className="container mx-auto grid justify-center mt-12 lg:grid-cols-4 gap-4 md:grid-cols-3 sm:grid-cols-2">
      {data.map((data, index) => (
